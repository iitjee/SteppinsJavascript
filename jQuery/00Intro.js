...
1. One common pattern is that when the page loads, you have to perform some kind of state initialization, 
like maybe setting up a product list. Then you set up some event-handlers, and you kick off the application. 

2. Another common scenario is that the user performs some kind of action on the page, such as selecting an element. Then your app 
...
3. A third common pattern is when your app has to fetch content from the server in order to update the page content. For example, 
...
JQuery leverages many of the skills you already have as a web developer.
...
JQuery also uses a concept called statement chaining to reduce the amount of code you ll have to write, and 
